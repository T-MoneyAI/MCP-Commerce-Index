...
export const mcpRegistry: MCPConfig[] = [
  ...
  },
  {
    ...
    name: 'Lobster.cash',
    category: 'wallets',
    npmPackage: '@crossmint/lobster.cash',
    githubRepo: null,
    description: 'Crossmint agent wallet for Solana — smart wallet integration for AI agents',
...

  {
    ...
    category: 'wallets',
    npmPackage: 'openclaw-iota-wallet',
    githubRepo: null,
    description: 'Machine-to-machine wallet on IOTA — bots hold funds, pay each other, trigger smart contracts',
  },
  {
    id: 'openclast-wallet',
    name: 'OpenClast Wallet',
    category: 'wallets',
    npmPackage: 'openclast-wallet',
    githubRepo: null,
    description: 'Native EVM wallet plugin for OpenClaw agents',
  },
  {
    id: 'loomlay-wallet',
    name: 'Loomlay Wallet',
    category: 'wallets',
    npmPackage: '@loomlay/openclaw-wallet-plugin',
    githubRepo: null,
    description: 'Multi-chain wallet with trading and DEX tools for AI agents',
  },
  {
    id: 'bsv-overlay',
    name: 'BSV Overlay',
    category: 'wallets',
    npmPackage: '@bsv/openclaw-overlay-plugin',
    githubRepo: null,
    description: 'Agent discovery, marketplace, and micropayments on BSV blockchain',
  },
  {
    id: 'unicity-wallet',
    name: 'Unicity',
    category: 'wallets',
    npmPackage: '@unicitylabs/openclaw-unicity',
    githubRepo: null,
    description: 'Wallet identity and encrypted DMs for OpenClaw agents — Sphere SDK',
  },
  {
    id: 'clawrouter',
    name: 'ClawRouter',
    category: 'protocols',
    npmPackage: '@blockrun/clawrouter',
    githubRepo: null,
    description: 'Smart LLM router with x402 micropayments — 30+ models, one wallet',
  },
